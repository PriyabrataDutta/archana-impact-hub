  ...
  <section className="relative min-h-screen flex items-end overflow-hidden">
    <div className="absolute inset-0">
      <img
        ...
        height={1080}
      />
      <div className="absolute inset-0 bg-gradient-to-t from-surface-hero via-surface-hero/85 to-surface-hero/30" />
    </div>
    <div className="relative z-10 w-full px-5 md:px-6 lg:px-12 max-w-7xl mx-auto pb-8 md:pb-24 pt-32 md:pt-40">
      <div className="max-w-3xl">
        ...
        >
          <div className="w-8 md:w-12 h-[1px] bg-accent-warm" />
          <p className="text-accent-warm text-[11px] md:text-[13px] font-semibold tracking-[0.2em] uppercase">
        ...
        <motion.h1
          ...
          className="font-display text-[2.5rem] leading-[1.1] md:text-6xl lg:text-[5.5rem] text-hero-foreground md:leading-[1.05] mb-6 md:mb-8 tracking-tight"
        >
          Transforming Vision.
          <br />
        ...
        <motion.p
          ...
          className="text-hero-foreground/70 text-base md:text-xl max-w-xl leading-relaxed mb-8 md:mb-12 font-light"
        >
      ...
      >
        {[
          ...
          { value: "3,000+", label: "Spectacles Given" },
          { value: "100+", label: "Rural Camps" },
        ].map((stat) => (
          <div key={stat.label} className="bg-surface-hero/60 backdrop-blur-sm px-4 md:px-6 py-5 md:py-5 text-center">
            <div className="font-display text-xl md:text-3xl text-accent-warm mb-1">{stat.value}</div>
            <p className="text-hero-foreground/50 text-[10px] md:text-xs tracking-widest uppercase">{stat.label}</p>
          </div>
        ))}
      </motion.div>
    </div>
